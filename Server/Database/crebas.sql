...
BEGIN TRANSACTION 
	BEGIN TRY
		...
		BEGIN
			RAISERROR(282,-1,-1, 'sp_XulyDangNhap');
			ROLLBACK
			RETURN
		END
...
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA) 
VALUES (N'Coca Cola', N'Đồ ăn liền', 30000)
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA)
VALUES( N'Pepsi',  N'Đồ ăn liền',15000 )
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA) 
VALUES (N'7Up', N'Đồ ăn liền', 15000)
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA)
VALUES( N'Cam ép',  N'Đồ ăn liền',10000 )
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA) 
VALUES (N'Chanh dây', N'Đồ ăn liền', 12000)
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA)
VALUES( N'Trà xanh không độ',  N'Đồ ăn liền',12000 )
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA) 
VALUES (N'Dr.Thanh trà giải nhiệt', N'Đồ ăn liền', 15000)
INSERT INTO dbo.THUCPHAM (TP_TEN, TP_LOAI, TP_GIA)
...
INSERT INTO dbo.NHANVIEN( NV_TEN, NV_GIOTINH, NV_SDT, NV_LUONG_GIO)
VALUES( N'Nguyễn Đức B', N'Nam', N'0123456789', 30000 )
...
INSERT INTO TAIKHOAN (UNAME,PWD,LOAITK, MA) VALUES ('ADMIN1', 1, 'ADMIN', 8)
